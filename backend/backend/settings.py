...
SECRET_KEY = 'django-insecure-your-secret-key' # This is fine for local development
DEBUG = True
ALLOWED_HOSTS = []
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('DB_PASSWORD', 'dhanshri'),
...
DEFAULT_FROM_EMAIL = 'no-reply@feedbacksystem.com'
